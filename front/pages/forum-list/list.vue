			...
			<view v-for="(item,index) in list " v-bind:key="index" class="listm flex flex-between">
				...
				<view class="listmr">
					...
					<view class="col3 f30 elip mb15">
						<button v-if="item.isdone=='开放'" class="cu-btn bg-green sm">in public</button>
						<button v-if="item.isdone=='关闭'" class="cu-btn bg-red sm">in private</button>
					</view>
					...
					<view class="flex flex-align-center mt20">
						<text class="colb f25">
							<button @tap="onDetailTap(item.id)" class="cu-btn bg-green shadow">see</button>
