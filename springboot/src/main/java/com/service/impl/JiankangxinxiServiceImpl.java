...
public class JiankangxinxiServiceImpl extends ServiceImpl<JiankangxinxiDao, JiankangxinxiEntity> implements JiankangxinxiService {
    ...
    @Override
    public List<Map<String, Object>> selectValue(Map<String, Object> params, Wrapper<JiankangxinxiEntity> wrapper) {
        return baseMapper.selectValue(params, wrapper);
    }

    @Override
    public List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params, Wrapper<JiankangxinxiEntity> wrapper) {
        return baseMapper.selectTimeStatValue(params, wrapper);
    }

    @Override
    public List<Map<String, Object>> selectGroup(Map<String, Object> params, Wrapper<JiankangxinxiEntity> wrapper) {
        return baseMapper.selectGroup(params, wrapper);
    }

    @Override
    public List<Map<String, Object>> riqitizhongSectionStat(Map<String, Object> params, Wrapper<JiankangxinxiEntity> wrapper) {
        return baseMapper.riqitizhongSectionStat(params, wrapper);
    }
    @Override
    public List<Map<String, Object>> riqixueyaSectionStat(Map<String, Object> params, Wrapper<JiankangxinxiEntity> wrapper) {
        return baseMapper.riqixueyaSectionStat(params, wrapper);
    }
    @Override
    public List<Map<String, Object>> riqixinlvSectionStat(Map<String, Object> params, Wrapper<JiankangxinxiEntity> wrapper) {
        return baseMapper.riqixinlvSectionStat(params, wrapper);
    }
