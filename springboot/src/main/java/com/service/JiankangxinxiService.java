...
public interface JiankangxinxiService extends IService<JiankangxinxiEntity> {
    ...
    List<Map<String, Object>> riqitizhongSectionStat(Map<String, Object> params,Wrapper<JiankangxinxiEntity> wrapper);
    List<Map<String, Object>> riqixueyaSectionStat(Map<String, Object> params,Wrapper<JiankangxinxiEntity> wrapper);
    List<Map<String, Object>> riqixinlvSectionStat(Map<String, Object> params,Wrapper<JiankangxinxiEntity> wrapper);
