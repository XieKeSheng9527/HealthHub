...
public interface JiankangxinxiDao extends BaseMapper<JiankangxinxiEntity> {
    ...
    List<Map<String, Object>> riqitizhongSectionStat(@Param("params") Map<String, Object> params,@Param("ew") Wrapper<JiankangxinxiEntity> wrapper);
    List<Map<String, Object>> riqixueyaSectionStat(@Param("params") Map<String, Object> params,@Param("ew") Wrapper<JiankangxinxiEntity> wrapper);
    List<Map<String, Object>> riqixinlvSectionStat(@Param("params") Map<String, Object> params,@Param("ew") Wrapper<JiankangxinxiEntity> wrapper);
