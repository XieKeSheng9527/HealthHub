...
public class JiankangxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,JiankangxinxiEntity jiankangxinxi,
		...
		if(tableName.equals("yonghu")) {
			jiankangxinxi.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R add(@RequestBody JiankangxinxiEntity jiankangxinxi, HttpServletRequest request){
    	//ValidatorUtils.validateEntity(jiankangxinxi);
    	jiankangxinxi.setUserid((Long)request.getSession().getAttribute("userId"));
        jiankangxinxiService.insert(jiankangxinxi);
        return R.ok();
    }
     ...
     * 分段统计
     */
    @RequestMapping("/sectionStat/tizhong/riqi")
    @IgnoreAuth
    public R riqitizhongSectionStat(HttpServletRequest request) {
        Map<String, Object> params = new HashMap<String, Object>();
        EntityWrapper<JiankangxinxiEntity> ew = new EntityWrapper<JiankangxinxiEntity>();
        String tableName = request.getSession().getAttribute("tableName").toString();
        if(tableName.equals("yonghu")) {
        ...
        List<Map<String, Object>> result = jiankangxinxiService.riqitizhongSectionStat(params, ew);
        return R.ok().put("data", result);
    }
    /**
     * 分段统计
     */
    @RequestMapping("/sectionStat/xueya/riqi")
    @IgnoreAuth
    public R riqixueyaSectionStat(HttpServletRequest request) {
        Map<String, Object> params = new HashMap<String, Object>();
        EntityWrapper<JiankangxinxiEntity> ew = new EntityWrapper<JiankangxinxiEntity>();
        String tableName = request.getSession().getAttribute("tableName").toString();
        if(tableName.equals("yonghu")) {
        ...
        List<Map<String, Object>> result = jiankangxinxiService.riqixueyaSectionStat(params, ew);
        return R.ok().put("data", result);
    }
    /**
     * 分段统计
     */
    @RequestMapping("/sectionStat/xinlv/riqi")
    @IgnoreAuth
    public R riqixinlvSectionStat(HttpServletRequest request) {
        Map<String, Object> params = new HashMap<String, Object>();
        EntityWrapper<JiankangxinxiEntity> ew = new EntityWrapper<JiankangxinxiEntity>();
        String tableName = request.getSession().getAttribute("tableName").toString();
        if(tableName.equals("yonghu")) {
        ...
        List<Map<String, Object>> result = jiankangxinxiService.riqixinlvSectionStat(params, ew);
        return R.ok().put("data", result);
    }
