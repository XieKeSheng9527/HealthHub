	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"14px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="身高(cm)" prop="shengao">
					<el-input  v-model="ruleForm.shengao" placeholder="身高(cm)" clearable  :readonly="ro.shengao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="身高(cm)" prop="shengao">
					<el-input v-model="ruleForm.shengao" placeholder="身高(cm)" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="体重(kg)" prop="tizhong">
					<el-input  v-model="ruleForm.tizhong" placeholder="体重(kg)" clearable  :readonly="ro.tizhong"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="体重(kg)" prop="tizhong">
					<el-input v-model="ruleForm.tizhong" placeholder="体重(kg)" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="饮食习惯" prop="yinshixiguan">
					<el-input  v-model="ruleForm.yinshixiguan" placeholder="饮食习惯" clearable  :readonly="ro.yinshixiguan"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="饮食习惯" prop="yinshixiguan">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="健身目标" prop="jianshenmubiao">
					<el-input  v-model="ruleForm.jianshenmubiao" placeholder="健身目标" clearable  :readonly="ro.jianshenmubiao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="健身目标" prop="jianshenmubiao">
					<el-input v-model="ruleForm.jianshenmubiao" placeholder="健身目标" readonly></el-input>
				</el-form-item>
