  ...
  <div :style='{"color":"#666","padding":"20px 30px 30px","fontSize":"14px"}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}'   v-if="flag=='yonghu'"  label="身高(cm)" prop="shengao">
          <el-input v-model="ruleForm.shengao"               placeholder="身高(cm)" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}'   v-if="flag=='yonghu'"  label="体重(kg)" prop="tizhong">
          <el-input v-model="ruleForm.tizhong"               placeholder="体重(kg)" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}'   v-if="flag=='yonghu'"  label="饮食习惯" prop="yinshixiguan">
          <el-input v-model="ruleForm.yinshixiguan"               placeholder="饮食习惯" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}'   v-if="flag=='yonghu'"  label="目标体重" prop="mubiaotizhong">
          <el-input v-model="ruleForm.mubiaotizhong"               placeholder="目标体重" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}'   v-if="flag=='yonghu'"  label="健身目标" prop="jianshenmubiao">
          <el-input v-model="ruleForm.jianshenmubiao"               placeholder="健身目标" clearable></el-input>
        </el-form-item>
