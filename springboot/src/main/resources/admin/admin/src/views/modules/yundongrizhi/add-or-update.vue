<template>
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"14px","color":"#666","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="运动项目" prop="yundongxiangmu">
					<el-input  v-model="ruleForm.yundongxiangmu" placeholder="运动项目" clearable  :readonly="ro.yundongxiangmu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="运动项目" prop="yundongxiangmu">
					<el-input v-model="ruleForm.yundongxiangmu" placeholder="运动项目" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="运动时长" prop="yundongshizhang">
					<el-input  v-model="ruleForm.yundongshizhang" placeholder="运动时长" clearable  :readonly="ro.yundongshizhang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="运动时长" prop="yundongshizhang">
					<el-input v-model="ruleForm.yundongshizhang" placeholder="运动时长" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="运动强度" prop="yundongqiangdu">
					<el-input  v-model="ruleForm.yundongqiangdu" placeholder="运动强度" clearable  :readonly="ro.yundongqiangdu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="运动强度" prop="yundongqiangdu">
					<el-input v-model="ruleForm.yundongqiangdu" placeholder="运动强度" readonly></el-input>
				</el-form-item>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yundongrizhi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yundongrizhiCrossAddOrUpdateFlag = false;
						 this.parent.search();
